...
const validateInputs = () => {
    ...
    {
        setError(mobile, 'Mobile number must be start with 6 or 7 or 8 or 9')
    }
    else
    {
        setSuccess(mobile);
    ...
    if(passwordValue === '') {
        ...
        {
            setError(password, 'Password should not be a password')
        }
      else if(passwordValue===usernameValue)  
      {
        setError(password, 'Password should not be same as username')
      }
     else {
        setSuccess(password);
    }
    ...
    if(password2Value === '') {
        ...
        setError(password2, "Passwords doesn't match.try again");
    } else {
